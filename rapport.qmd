...
C’est John Graunt, tailleur de son état, qui a réalisé l’une des premières tentatives d’exploitation des registres paroissiaux de décès en Angleterre et au pays de Galles. Ces registres, au nombre de 10 000, contenaient des informations sur le sexe, l’âge et la cause supposée de la mort. L’une des contributions majeures de cette époque à l’analyse des données de décès fut la construction des tables de vie, également appelées tables de vitalité, suggérées initialement par John Graunt et mises en œuvre par Edmund Halley. Le premier recensement anglais a permis de collecter des informations détaillées sur le nombre de décès par maladie et a mis en lumière les conditions sanitaires souvent déplorables dans les villes. Ainsi, les données sur la santé ont toujours constitué un élément central de l’analyse statistique. Le souhait de mesurer et d’évaluer la santé nationale a été le moteur de la mise en place des premiers systèmes d’analyse statistique. Aujourd’hui encore, des questions se posent sur le lien entre le niveau de développement des pays et les causes de décès, ainsi que sur les similarités entre pays. Pour y répondre, nous allons réaliser une analyse factorielle des correspondances à partir de données de 2019 concernant 204 pays et 31 causes de décès.
