...
La première étape de l'analyse consiste (de toute évidence) à charger les librairies n&cessaires ainsi que le jeu de données à analyser dans le script R qui est le fichier CSV nettoyé. Après l’importation, une première visualisation globale du tableau est réalisée afin de vérifier la structure des données et la cohérence des variables.
...
L’analyse met en évidence des profils de mortalité contrastés. En Arménie, en 2019, la cause C12 est responsable de plus de 12 000 décès, tandis que la cause C20 en représente environ 6 000. En France, ces mêmes causes figurent également parmi les principales causes de mortalité, avec plus de 15 000 décès pour la cause C20 et environ 20 000 pour la cause C12. À l’inverse, au Mali, les maladies transmissibles ainsi que certaines causes évitables occupent une place plus importante dans la mortalité totale : la cause C14 a entraîné environ 32 000 décès, la cause C12 près de 20 000 décès, et les causes C18 et C25 environ 14 000 décès chacune.
